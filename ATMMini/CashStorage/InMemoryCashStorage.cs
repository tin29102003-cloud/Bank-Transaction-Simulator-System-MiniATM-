...
namespace ATMMini.infrastructure.CashStorage
{
    public class InMemoryCashStorage : ICashStorage
    {//khi chung ta kiem  tra và rút tiền nó sẽ log ra
        ...
        public bool Withdraw(double amount)
        {
            ...
            try
            {
                ...
                //nếu 2 thread đc rút tiền thì dúng spin lock gióng nhu  squelize bên nodejs cũng có lock là true
